...
import { AcceptedLanguages } from './models/AcceptedLanguages';
...
const ChatWindow: React.FC<IProps> = (props: IProps) => {
  ...
  async function query(question: string) {
    const prediction = await client.createPrediction({
      chatflowId: '5e6dd518-bf1a-46f1-bbf0-ad92afd83b71',
      question,
      streaming: true,
    });
    return prediction;
  ...
  const chatBodyHeight = isOpen ? 'calc(350px - 22px)' : '0px'; // Adjust 350px to desired open height
  ...
  return (
    ...
    <div style={{
      ...
      height: isOpen ? '350px' : '22px', // Animate height based on isOpen state
